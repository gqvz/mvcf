...
import {
    UserSeenStatusFromJSON,
    UserSeenStatusFromJSONTyped,
    UserSeenStatusToJSON,
    UserSeenStatusToJSONTyped,
} from './UserSeenStatus';
...
export function GetRequestResponseToJSONTyped(value?: GetRequestResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
