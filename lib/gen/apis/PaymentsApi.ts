...
import {
    ...
    EditPaymentStatusRequestFromJSON,
...
export class PaymentsApi extends runtime.BaseAPI {
     ...
     * Edit payment status
     */
    async editPaymentStatusRaw(requestParameters: EditPaymentStatusOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
     ...
     * Edit payment status
     */
    async editPaymentStatus(requestParameters: EditPaymentStatusOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
     ...
     * Get a payment by ID
     */
    async getPaymentByIdRaw(requestParameters: GetPaymentByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetPaymentResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Get a payment by ID
     */
    async getPaymentById(requestParameters: GetPaymentByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetPaymentResponse> {
     ...
     * Get payments
     */
    async getPaymentsRaw(requestParameters: GetPaymentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<GetPaymentResponse>>> {
        const queryParameters: any = {};
     ...
     * Get payments
     */
    async getPayments(requestParameters: GetPaymentsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<GetPaymentResponse>> {
