...
import type { CreateItemRequest, CreateItemResponse, EditItemRequest, GetItemResponse } from '../models/index';
import {
...
export class ItemsApi extends runtime.BaseAPI {
   ...
   */
  async createItemRaw(
    requestParameters: CreateItemOperationRequest,
   ...
   */
  async editItemRaw(
    requestParameters: EditItemOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError('id', 'Required parameter "id" was null or undefined when calling editItem().');
    }
   ...
   * Get item by ID
   */
  async getItemByIdRaw(
    requestParameters: GetItemByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ...
  async getItemsRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<GetItemResponse>>> {
    const queryParameters: any = {};
