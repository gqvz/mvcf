...
export class OrderItemsApi extends runtime.BaseAPI {
   ...
   * Create a new order item
   */
  async createOrderItemRaw(
    requestParameters: CreateOrderItemOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<CreateOrderItemResponse>> {
   ...
   */
  async editOrderItemStatusRaw(
    requestParameters: EditOrderItemStatusOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   * Get order items
   */
  async getOrderItemsRaw(
    requestParameters: GetOrderItemsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<GetOrderItemResponse>>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
        'id',
  ...
  async getOrderItems(
    requestParameters: GetOrderItemsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<GetOrderItemResponse>> {
   ...
   */
  async getOrderItemsByStatusRaw(
    requestParameters: GetOrderItemsByStatusRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<GetOrderItemResponse>>> {
    const queryParameters: any = {};
