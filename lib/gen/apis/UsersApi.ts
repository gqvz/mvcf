...
export class UsersApi extends runtime.BaseAPI {
   ...
   */
  async editUserRaw(
    requestParameters: EditUserOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<EditUserResponse>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError('id', 'Required parameter "id" was null or undefined when calling editUser().');
    }
