...
export default function NavbarComponent(): React.JSX.Element {
  ...
  const handleCheckbox = (value: number) => {
    setSelectedRoles((prev) => ((prev & value) === value ? prev & ~value : prev | value));
  };
        ...
        <Container fluid>
          ...
          <Navbar.Collapse id="navbarSupportedContent">
            ...
            <div className="d-flex">
              <span className="text-center align-content-center me-3">
                Hi, <code>{username}</code>
              </span>
              <Button variant="outline-secondary" className="me-3" onClick={() => setShowRoleChangeModal(true)}>
                Change roles
              </Button>
